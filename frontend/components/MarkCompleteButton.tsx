...
export default function MarkCompleteButton({ lessonId, moduleId }: Props) {
  ...
  const baseClasses =
    "w-full rounded-sm py-4 font-display text-xl tracking-wide transition-all disabled:opacity-60";
  const stateClasses = done
    ? "bg-success text-black hover:bg-emerald-400 shadow-glow"
    : "bg-gold text-black hover:bg-amber-400 hover:shadow-glow-gold";
